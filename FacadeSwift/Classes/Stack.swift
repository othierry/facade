    ...
    withCompletionHandler completionHandler: ((NSError?) -> Void)?)
  {
    ...
    managedObjectContext.perform {
      ...
      do {
        ...
        guard
          let parentManagedObjectContext = managedObjectContext.parent
          , parentManagedObjectContext != self.rootManagedObjectContext
          else { return complete(nil) }
    ...
    _ managedObjectContext: NSManagedObjectContext = Stack.sharedInstance.mainManagedObjectContext)
  {
    managedObjectContext.performAndWait {
      ...
      do {
        ...
        if let parentManagedObjectContext = managedObjectContext.parent
          , parentManagedObjectContext != self.rootManagedObjectContext
        {
