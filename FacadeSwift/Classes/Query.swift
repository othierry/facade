...
open class Query<A: NSManagedObject> {
  ...
  @discardableResult open func limit(_ x: Int) -> Self {
    fetchRequest.fetchLimit = x
    return self
  }
  
  @discardableResult open func offset(_ x: Int) -> Self {
    fetchRequest.fetchOffset = x
    return self
  }
  
  @discardableResult open func fetchBatchSize(_ x: Int) -> Self {
    fetchRequest.fetchBatchSize = x
    return self
  }
  
  @discardableResult open func prefetch(_ relations: [String]) -> Self {
    fetchRequest.relationshipKeyPathsForPrefetching = relations
    return self
  }
  
  @discardableResult open func faults(_ returnsFaults: Bool) -> Self {
    fetchRequest.returnsObjectsAsFaults = returnsFaults
    return self
  }
  
  @discardableResult open func refresh(_ refreshRefetchedObjects: Bool) -> Self {
  ...
  @discardableResult open func inManagedObjectContext(_ managedObjectContext: NSManagedObjectContext) -> Self {
  ...
  /// :return self
  @discardableResult open func sort(_ sortStr: String) -> Self {
  ...
  /// :return: self
  @discardableResult open func with(_ key: String, containing value: String, options: QueryOptions = .None) -> Self {
  ...
  /// - parameter diacriticSensitive: consider the search diacritic sensitive
  /// :return: self
  @discardableResult open func with(_ key: String, like value: String, options: QueryOptions = .None) -> Self {
    let modifier = modifierFor(options)
    predicates.append(
      NSPredicate(
  ...
  /// :return: self
  @discardableResult open func with(_ key: String, existing exists: Bool) -> Self {
    let matcher = exists ? "!=" : "=="
    predicates.append(
      NSPredicate(
  ...
  /// - parameter diacriticSensitive: consider the search diacritic sensitive
  /// :return: self
  @discardableResult open func with(_ key: String, endingWith suffix: String, options: QueryOptions = .None) -> Self {
    let modifier = modifierFor(options)
    predicates.append(
      NSPredicate(
  ...
  /// - parameter diacriticSensitive: consider the search diacritic sensitive
  /// :return: self
  @discardableResult open func with(_ key: String, startingWith prefix: String, options: QueryOptions = .None) -> Self {
    let modifier = modifierFor(options)
    predicates.append(
      NSPredicate(
  ...
  ///
  /// - parameter key: the entity's property name
  /// - parameter notEqualTo: the value
  /// - parameter caseSensitive: consider the search case sensitive
  /// - parameter diacriticSensitive: consider the search diacritic sensitive
  /// :return: self
  @discardableResult open func with(_ key: String, notEqualTo value: Any?, options: QueryOptions = .None) -> Self {
    guard value != nil else {
  ...
  /// :return: self
  @discardableResult open func with(_ key: String, greaterThan value: Double) -> Self {
    predicates.append(
      NSPredicate(
        format: "\(key) > %@",
        argumentArray: [value]))
  ...
  /// :return: self
  @discardableResult open func with(_ key: String, greaterThanOrEqual value: Double) -> Self {
    predicates.append(
      NSPredicate(
        format: "\(key) >= %@",
        argumentArray: [value]))
  ...
  /// - parameter greaterThan: the value
  /// :return: self
  @discardableResult open func with(_ key: String, greaterThan value: Int) -> Self {
    predicates.append(
      NSPredicate(
        format: "\(key) > %@",
        argumentArray: [value]))
  ...
  /// - parameter greaterThanOrEqual: the value
  /// :return: self
  @discardableResult open func with(_ key: String, greaterThanOrEqual value: Int) -> Self {
    predicates.append(
      NSPredicate(
        format: "\(key) >= %@",
        argumentArray: [value]))
  ...
  /// :return: self
  @discardableResult open func with(_ key: String, lowerThan value: Double) -> Self {
    predicates.append(
      NSPredicate(
        format: "\(key) < %@",
        argumentArray: [value]))
  ...
  /// :return: self
  @discardableResult open func with(_ key: String, lowerThanOrEqual value: Double) -> Self {
    predicates.append(
      NSPredicate(
        format: "\(key) <= %@",
        argumentArray: [value]))
  ...
  /// - parameter lowerThan: the value
  /// :return: self
  @discardableResult open func with(_ key: String, lowerThan value: Int) -> Self {
    predicates.append(
      NSPredicate(
        format: "\(key) < %@",
        argumentArray: [value]))
  ...
  /// - parameter lowerThanOrEqual: the value
  /// :return: self
  @discardableResult open func with(_ key: String, lowerThanOrEqual value: Int) -> Self {
    predicates.append(
      NSPredicate(
        format: "\(key) <= %@",
        argumentArray: [value]))
  ...
  open func count() -> Int {
    ...
    managedObjectContext.performAndWait {
      do {
        ...
        let _ = self.shouldHandleError(error)
      }
    }
